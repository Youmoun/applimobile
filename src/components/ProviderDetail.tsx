  ...
  return (
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center p-4 z-50">
      <div className="card max-w-2xl w-full p-6 bg-white relative">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            {isOwner && (
              <div className="mt-3">
                <button className="btn-secondary px-3 py-1 rounded-xl" onClick={() => setEditing(true)}>
      ...
      {editing && (
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center p-4 z-50">
          <div className="card max-w-2xl w-full p-6 bg-white relative">
            <button className="absolute right-3 top-3 text-gray-500 hover:text-gray-900" onClick={()=>setEditing(false)}>✕</button>
